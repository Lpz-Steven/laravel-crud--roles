...
<html lang="en">
  ...
  <body class="bg-gray-100 text-grey-800">
    @yield('content')
  <nav class="flex py-5 bg-indigo-500 text-white">
    <div class="w-1/2 px-12 mr-auto">
        <p class="text-2xl font-bold">My Applicacion</p>
    </div>
    ...
    <ul class="w-1/2 px-16 ml-auto flex justify-end pt-1">
      @if(auth()->check())
        ...
        <li>
            <a href="{{route('login.destroy')}}" class="font-bold py-2 px-4 rounded-md bg-red-500 hover:bg-red-600 hover:text-indigo-700">Log Out</a>
        </li>
        @else
        <li class="mx-6">
